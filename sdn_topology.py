...
class SDNTopo(Topo):
    ...
    def __init__(self, k=4, **opts):
        ...
        self.addLink(s1, s10, bw=500)
        self.addLink(s2, s20, bw=500)

        # Connect the edge switches with 2 switches
        self.addLink(s1, core_switch_list[0], bw=1000)
        self.addLink(s1, core_switch_list[1], bw=1000)
        self.addLink(s2, core_switch_list[-1], bw=1000)
        self.addLink(s2, core_switch_list[-2], bw=1000)
        ...
        # Make STP links
        self.addLink(core_switch_list[1], core_switch_list[3], bw=1000)

        # DEBUG: Add one host to each core switch
        h3 = self.addHost("h3", ip="10.10.10.110/24", bw=1000)
        h4 = self.addHost("h4", ip="10.10.10.120/24", bw=1000)
        self.addLink(h3, core_switch_list[0], bw=1000)
        self.addLink(h4, core_switch_list[1], bw=1000)
